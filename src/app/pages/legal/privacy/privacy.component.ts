...
export class PrivacyComponent {
  ...
  content: Record<string, { title: string; text: string }[]> = {
    en: [
      { title: 'Responsible Party', text: 'Marc Odermatt, Emmetten, Switzerland. Email: hello@marcoder.com' },
      ...
      { title: 'Your Rights', text: 'You have the right to request information about your stored personal data, as well as the right to correction, deletion, or restriction of processing. Contact us at hello@marcoder.com for any privacy-related requests.' },
    ],
    de: [
      { title: 'Verantwortliche Stelle', text: 'Marc Odermatt, Emmetten, Schweiz. E-Mail: hello@marcoder.com' },
      ...
      { title: 'Ihre Rechte', text: 'Sie haben das Recht auf Auskunft über Ihre gespeicherten personenbezogenen Daten sowie das Recht auf Berichtigung, Löschung oder Einschränkung der Verarbeitung. Kontaktieren Sie uns unter hello@marcoder.com für datenschutzbezogene Anfragen.' },
    ],
  };
